            ...
            <div class="bread_bg">    
                  <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                              <div class="bread_nav">
                                    <span class="fa fa-home" aria-hidden="true"></span>&nbsp;<a href="<?php echo W('Index',array('cnen'=>'en','lang'=>'e'));?>">Home</a> &gt; Product Search
                              </div>
                        </div>
                  </div>
            </div>
            ...
            <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                        ...
                        <div class="product_list product_list2">
                              <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-4 col-md-4 col-mm-6 product_img">
                                    ...
                                    <p class="product_title">
                                          <a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>'Product','lang'=>'e'));?>"><?php echo (redword($vo["ename"],26,$keyword)); ?></a>
                                    </p>
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-3">
                        ...
                        <div class="left_column">
                              <?php echo W('Left',array('id'=>$pid['id'],'type'=>'product','lang'=>'e'));?>
                        </div>
                        <div class="left_news">
