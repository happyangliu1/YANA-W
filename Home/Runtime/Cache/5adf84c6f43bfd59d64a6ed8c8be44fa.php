           ...
           <div class="row">
                 ...
                 <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                        ...
                        <div class="right_contents">
                              <h1 class="right_contents_h1"><?php echo ($article["title"]); ?></h1>
                        ...
                        <div class="relevant_new"> 
                              ...
                              <ul class="right_new">
                                    <?php if(is_array($related)): $i = 0; $__LIST__ = array_slice($related,0,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                          <a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>'New','lang'=>'c'));?>" title="<?php echo ($vo["title"]); ?>"><?php echo (mb_substr($vo["title"],0,50,'utf-8')); ?></a>
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-3">
                        ...
                        <div class="left_column">
                              <?php echo W('Left',array('id'=>$article['bid'],'type'=>'new','lang'=>'c'));?>
                        </div>
                        <div class="left_news">
