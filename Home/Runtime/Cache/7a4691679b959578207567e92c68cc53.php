           ...
           <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                        ...
                        <div class="col-sm-11 col-md-8 col-md-offset-2" style="margin-bottom:30px; margin-top:20px;">
                              <ul class="showpic_flash">
                                    <?php if(is_array($photo)): $i = 0; $__LIST__ = $photo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                          <a class="example-image-link" href="__ROOT__/Uploads/<?php echo ($photo[$key]); ?>" data-lightbox="example-set" target="_blank"><img class="example-image" src="__ROOT__/Uploads/<?php echo ($photo[$key]); ?>" alt="<?php echo ($article["ename"]); ?>"/></a>
                        ...
                        <div class="list_related"> 
                              ...
                              <div class="product_list related_list">
                                    <?php if(is_array($related)): $i = 0; $__LIST__ = array_slice($related,0,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-4 col-md-3 col-mm-6 case_img">
                                          ...
                                          <p class="case_title">
                                                <a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>'Photo','lang'=>'e'));?>" title="<?php echo ($vo["ename"]); ?>"><?php echo (mb_substr($vo["ename"],0,28,'utf-8')); ?></a>
                                          </p>
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-3">
                        ...
                        <div class="left_column">
                              <?php echo W('Left',array('id'=>$article['bid'],'type'=>'photo','lang'=>'e'));?>
                        </div>
                        <div class="left_news">
