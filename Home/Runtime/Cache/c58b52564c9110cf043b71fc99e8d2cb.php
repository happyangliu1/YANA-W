            ...
            <div class="bread_bg">    
                  <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                              <div class="bread_nav">
                                    <span class="fa fa-home" aria-hidden="true"></span>&nbsp;<?php echo W('Bread',array('id'=>$article['pid'],'lang'=>'c'));?>
                              </div>
                        </div>
                  </div>
            </div>
                        ...
                        <div class="list_box">
                              ...
                              <div class="col-sm-12 col-md-6 showpic_box">
                                    <ul class="showpic_flash">
                                          <?php if(is_array($photo)): $i = 0; $__LIST__ = $photo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                                <a class="example-image-link" href="__ROOT__/Uploads/<?php echo ($photo[$key]); ?>" data-lightbox="example-set" target="_blank"><img class="example-image" src="__ROOT__/Uploads/<?php echo ($photo[$key]); ?>" alt="<?php echo ($article["name"]); ?>"/></a>
                              ...
                              <div class="col-sm-12 col-md-6 proinfo_box">
                                    ...
                                    <div class="product_info">
                                          <p><?php echo (nl2br($article["introduce"])); ?></p>
                                          ...
                                          <?php if($article["buyname"] != ''): ?><a href="<?php echo ($article["buylink"]); ?>" class="btn btn-info page-btn"  target="_blank">
                                                      <span class="fa fa-shopping-cart" aria-hidden="true"></span>&nbsp;&nbsp;<?php echo ($article["buyname"]); ?>
                                                </a><?php endif; ?>
                                          </div>
                                    </div>
                              </div>
                                    ...
                                    <form id="myform" name="myform" class="form-horizontal" method="post" action="__ROOT__/?m=Inquiry&a=check&g=c" onSubmit="return CheckJob()">
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                      ...
                                                      <input type="hidden" name="pid" value="<?php echo ($article["id"]); ?>">
                                                </div>
                                          </div>
                              ...
                              <div class="product_list related_list">
                                    <?php if(is_array($related)): $i = 0; $__LIST__ = array_slice($related,0,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-4 col-md-3 col-mm-6 product_img">
                                          ...
                                          <p class="product_title">
                                                <a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>'Product','lang'=>'c'));?>" title="<?php echo ($vo["name"]); ?>"><?php echo (mb_substr($vo["name"],0,12,'utf-8')); ?></a>
                                          </p>
