            ...
            <div class="container">    
                  <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                              <div class="bread_nav">
                                    <span>Your location: </span><a href="<?php echo W('Index',array('cnen'=>'en','lang'=>'e'));?>">Home</a> &gt; 404 error page
                              </div>
                        </div>
                  </div>
            </div>
      ...
      <div class="container">    
            <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                        ...
                        <h1 style=" clear:both; text-align: center; line-height: 40px;padding-top:10px;">Error 404: The page does not exist or has been deleted</h1>
                        <ul class="ul_sitemap">
                              <li>
                                    <a href="<?php echo W('Index',array('cnen'=>'en','lang'=>'e'));?>" target="_blank">Home</a>
                              </li>
