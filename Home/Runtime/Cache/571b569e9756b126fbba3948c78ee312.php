            ...
            <div class="bread_bg">    
                  <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                              <div class="bread_nav">
                                    <span class="fa fa-home" aria-hidden="true"></span>&nbsp;<a href="<?php echo W('Index',array('cnen'=>'cn','lang'=>'c'));?>">网站首页</a> &gt; 在线留言
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                        ...
                        <div class="feedback">
                              ...
                              <?php if(is_array($bigform)): $i = 0; $__LIST__ = $bigform;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; switch($vo["type"]): case "text": ?><div class="form-group">
                                          <label for="<?php echo ($vo["fieldname"]); ?>"class="col-sm-3 control-label"><?php echo ($vo["name"]); ?>：</label>
                                          <div class="col-sm-6">
                                                <input type="text" name="<?php echo ($vo["fieldname"]); ?>" class="form-control" id="<?php echo ($vo["fieldname"]); ?>" <?php if($vo["required"] == 1): ?>placeholder="必填" required="required"<?php endif; ?>>
                                          </div>
                                    </div><?php break;?>

                              <?php case "email": ?><div class="form-group">
                                          <label for="inputEmail" class="col-sm-3 control-label"><?php echo ($vo["name"]); ?>：</label>
                                          <div class="col-sm-6">
                                                <input type="email" name="<?php echo ($vo["fieldname"]); ?>" class="form-control" id="inputEmail" <?php if($vo["required"] == 1): ?>placeholder="必填" required="required"<?php endif; ?>>
                                          </div>
                                    </div><?php break;?>

                              <?php case "radio": ?><div class="form-group">
                                          <label class="col-xs-12 col-sm-3 control-label"><?php echo ($vo["name"]); ?>：</label>
                                          ...
                                          <?php if(is_array($smallform)): $i = 0; $__LIST__ = $smallform;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$svo): $mod = ($i % 2 );++$i; if(($svo["pid"]) == $vo["id"]): ?><label class="radio-inline">
                                                      <input type="radio" name="<?php echo ($svo["fieldname"]); ?>" value="<?php echo ($svo["name"]); ?>" <?php if($vo["required"] == 1): ?>required="required"<?php endif; ?>/><?php echo ($svo["name"]); ?>
                              ...
                              <?php case "select": ?><div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-6">
                                                ...
                                                <?php if(is_array($smallform)): $i = 0; $__LIST__ = $smallform;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$svo): $mod = ($i % 2 );++$i; if(($svo["pid"]) == $vo["id"]): ?><option value="<?php echo ($svo["name"]); ?>"><?php echo ($svo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                              ...
                              <?php case "textarea": ?><div class="form-group">
                                          <label for="contents" class="col-sm-3 control-label"><?php echo ($vo["name"]); ?>：</label>
                                          <div class="col-sm-6">
