            ...
            <div class="container">    
                  <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                              <div class="bread_nav">
                                    <span>您的位置：</span><a href="<?php echo W('Index',array('cnen'=>'cn','lang'=>'c'));?>">网站首页</a> &gt; 404错误页面
                              </div>
                        </div>
                  </div>
            </div>
      ...
      <div class="container">    
            <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                        ...
                        <ul class="ul_sitemap">
                        <li>
                              <a href="<?php echo W('Index',array('cnen'=>'cn','lang'=>'c'));?>" target="_blank">网站首页</a>
                        </li>
