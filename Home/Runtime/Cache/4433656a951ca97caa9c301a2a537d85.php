...
<html lang="en">
  <head>
    ...
    <title><?php echo ($name); ?>-<?php echo (C("seo_etitle")); ?></title>
            ...
            <div class="bread_bg">    
                  <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                              <div class="bread_nav">
                                    <span class="fa fa-home" aria-hidden="true"></span>&nbsp;<a href="<?php echo W('Index',array('cnen'=>'en','lang'=>'e'));?>">Home</a> &gt; TAGS
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                        ...
                        <ul  class="right_new tags_ul">
                              <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                    <h3>
                                          <a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>$type,'lang'=>'e'));?>" target="_blank"><?php echo (redword($vo["etitle"],50,$name)); ?></a>
                                    </h3>
                                    <p class="tags_p"><?php echo (redword($vo["edescription"],200,$name)); ?></p>
...
<div class="container"> 
	<div class="row">
		<div class="col-xs-12 col-sm-4 col-md-4 footer_contact">
			...
			<p>Email Us: <a style="color:#fff" href="mailto:<?php echo (C("web_email")); ?>"> <?php echo (C("web_email")); ?></a></p>
...
<div class="footer-bar" style="padding: 10px 0;text-align: center;color: #727272; background-color: #ebebeb;">
	<div>	
		...
		<?php if(C("is_translate")!= 0): ?><p style="padding:0px; text-align:center;">	<SCRIPT language=javascript src="/e25/Home/Tpl/default/Public/images/lang.js"></SCRIPT>		
              <A 
                  ...
                  height=14> <SPAN style="COLOR: #707070">Russian</SPAN></A> </p><?php endif; ?>
				  			  


		<p><?php echo (C("web_ecopyright")); ?>&nbsp;<a href="__ROOT__/e_sitemap.html" target="_blank" >Sitemap</a><?php echo (C("web_count")); ?> </p>
	</div>
</div>
