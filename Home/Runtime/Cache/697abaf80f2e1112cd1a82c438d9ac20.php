	...
	<div class="container">    
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="bread_nav">
					<span>Your location: </span><?php echo W('Bread',array('id'=>$listid,'lang'=>'e'));?>					
				</div>
			</div>
		</div>
	</div>
...
<div class="container">    
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
			...
			<ul class="right_new">
				<?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="col-xs-12 col-sm-12 col-md-12">	
						<div class="col-md-3">
							<a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>$table,'lang'=>'e'));?>" title="<?php echo ($vo["etitle"]); ?>"><img src="__ROOT__/Uploads/<?php echo ($vo["thumb"]); ?>" width="100%"/></a>
						</div>
						<div class="col-md-9">
							<div class="title"><a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>$table,'lang'=>'e'));?>" title="<?php echo ($vo["etitle"]); ?>"><?php echo ($vo["etitle"]); ?></a></div>
							<div class="time"><i class="fa fa-calendar" aria-hidden="true"></i><?php echo (date('Y-m-d',$vo["time"])); ?></div>					 
							<div class="zhai"><?php echo ($vo["edescription"]); ?></div>
							<div style="padding:20px 0;" class="new_bnt" > <a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>$table,'lang'=>'e'));?>" class="new_bnt" title="<?php echo ($vo["etitle"]); ?>">READ MORE <i class="fa fa-angle-double-right" aria-hidden="true"></i> </a></div> 
						</div>
    ...
    <div class="col-xs-12 col-sm-4 col-md-3">
    	...
    	<div class="left_news">
    		...
    		<a href="#"><img class="alignnone size-full wp-image-171" src="__ROOT__/Uploads/<?php echo W('Flash',array('type'=>3,'id'=>17));?>" alt="" width="260px" ></a>
