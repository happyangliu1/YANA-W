...
class CommonAction extends Action{
	...
	//缩略图
	protected function dothumb($image,$maxwidth,$maxheight){
		import('@.Org.Image');
		Image::thumb2($image,$image,'',$maxwidth,$maxheight,true);
	}
	...
	protected function uploaddown(){
		import('ORG.Net.UploadFile');
		$upload=new UploadFile();
		$upload->allowExts=array('rar','zip','pdf','doc','xls','ppt','docx','xlsx','pptx','apk','gif','jpg','bmp','jpeg','png');
