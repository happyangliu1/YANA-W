...
<UL>
  ...
  <LI class="Black" style="font-size:13px; color:#12793b;">提示：需要更改LOGO或二维码图片时，请先点击删除该图片，即可上传。</LI>
  </UL>
</DIV>
  ...
  <TR>
    <TD style="border: currentColor;">
      ...
      <TABLE width="100%" class="Font" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>Whatsapp</SPAN></TD>
          <TD style="padding-top: 5px; padding-bottom: 5px;"><input name="web_icp" value="<?php echo (C("web_icp")); ?>" type="text" class="FormSmall" style="width: 450px;"></TD></TR>
        <TR class="secondalt">
        ...
        <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>谷歌验证代码</SPAN></TD>
          <TD style="padding-top: 5px; padding-bottom: 5px;"><textarea name="web_Google_Verification" class="FormSmall" style="width: 450px; height:40px;"><?php echo (C("web_Google_Verification")); ?></textarea></TD></TR>
	    	<TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>谷歌全局代码(head)</SPAN></TD>
          <TD style="padding-top: 5px; padding-bottom: 5px;"><textarea name="web_Google_All" class="FormSmall" style="width: 450px; height:40px;"><?php echo (C("web_Google_All")); ?></textarea></TD></TR>
		    <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>谷歌事件代码(body)</SPAN></TD>
          <TD style="padding-top: 5px; padding-bottom: 5px;"><textarea name="web_Google_Events" class="FormSmall" style="width: 450px; height:40px;"><?php echo (C("web_Google_Events")); ?></textarea></TD></TR>
      ...
      <TABLE width="100%" class="Font" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>联系手机 (英)</SPAN></TD>
          <TD style="padding-top: 5px; padding-bottom: 5px;"><input name="web_ephone" value="<?php echo (C("web_ephone")); ?>" type="text" class="FormSmall" style="width: 220px;"></TD></TR>
      ...
      <TABLE width="100%" class="Font" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>缩略图裁剪</SPAN></TD>
          <TD style="padding-top: 10px; padding-bottom: 10px;"><input name="is_thumb" type="radio" value="1" <?php if(C("is_thumb")== 1): ?>checked="checked"<?php endif; ?>> 开启 &nbsp;
          <input name="is_thumb" type="radio" value="0" <?php if(C("is_thumb")== 0): ?>checked="checked"<?php endif; ?>> 关闭</TD></TR>
        <TR class="firstalt">
        ...
        <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>在线翻译工具</SPAN></TD>
          <TD style="padding-top: 5px; padding-bottom: 5px;"><input name="is_translate" type="radio" value="1" <?php if(C("is_translate")== 1): ?>checked="checked"<?php endif; ?>> 开启 &nbsp;
          <input name="is_translate" type="radio" value="0" <?php if(C("is_translate")== 0): ?>checked="checked"<?php endif; ?>> 关闭<span style="color:#F00; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;( 说明：此翻译工具属于第三方网站，翻译时会卡，是第三方网站原因，非我们程序卡。)</span></TD></TR>
        <!-- <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>是否重命名上传文件</SPAN></TD>
          <TD style="padding-top: 10px; padding-bottom: 10px;"><input name="rename_up" type="radio" value="1" <?php if(C("rename_up")== 1): ?>checked="checked"<?php endif; ?>> 是 &nbsp;
          <input name="rename_up" type="radio" value="0" <?php if(C("rename_up")== 0): ?>checked="checked"<?php endif; ?>> 否</TD></TR> -->
        <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>暂时关闭网站</SPAN></TD>
          <TD style="padding-top: 5px; padding-bottom: 5px;"><input name="is_index" type="radio" value="1" <?php if(C("is_index")== 1): ?>checked="checked"<?php endif; ?>> 是 &nbsp;
          <input name="is_index" type="radio" value="0" <?php if(C("is_index")== 0): ?>checked="checked"<?php endif; ?>> 否</TD></TR>
      ...
      <TABLE width="100%" class="Font" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR class="secondalt" style="display:none;">
        ...
        <TR class="firstalt" style="display:none;">
      ...
      <TABLE width="100%" class="Font" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR class="secondalt">
          <TD style="padding-left: 5px;"><SPAN>facebook</SPAN></TD>
        ...
        <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>google</SPAN></TD>
        ...
        <TR class="secondalt">
          <TD style="padding-left: 5px;"><SPAN>instagram</SPAN></TD>
        ...
        <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>youtube</SPAN></TD>
        ...
        <TR class="secondalt">
          <TD style="padding-left: 5px;"><SPAN>twitter</SPAN></TD>
        ...
        <TR class="firstalt">
          <TD style="padding-left: 5px;"><SPAN>linkedin </SPAN></TD>
