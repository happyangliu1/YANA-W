...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="LineRightBlue1">
      ...
      <tr>
        <td width="88%" height="24">快捷操作：<a href="<?php echo U('Feedback/alldel');?>" class='alldel'>删除全部留言</a></td>
  ...
  <div id="languageBox2">
    <div class="tablelist">
    <?php if(is_array($feed)): $i = 0; $__LIST__ = $feed;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul onmouseover="this.style.background ='#FFFDD7'" onmouseout="this.style.background ='#FFFFFF'" style="height:35px;">
          <li class="li_10"><?php echo ($vo["id"]); ?></li>
          <li class="li_40"><a href="<?php echo U('view',array('id'=>$vo['id']));?>"><?php echo (mb_substr($vo["textarea"],0,40,'utf-8')); ?></a></li>
