...
<style type="text/css">
.proimg{max-width: 80px; margin-bottom: 10px;}
</style>
</head>
<body>
...
<form action="<?php echo U('del',array('id'=>$inquiry['id']));?>" method="post" name="myform">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ListCategory" style="margin-top:10px;">
		...
		<tr class="firstalt">
			<td width="15%" height="25"><span style="padding-left:10px;">产品图片：</span></td>
			<td><a href="__ROOT__/Uploads/<?php echo ($inquiry["thumb"]); ?>" target= "_blank"><img src="__ROOT__/Uploads/<?php echo ($inquiry["thumb"]); ?>" class="proimg"/></a></td>
		</tr>
		<tr class="secondalt">
			<td height="35"><span style="padding-left:10px;">产品名称：</span></td>
			<td><?php echo ($inquiry["product_name"]); ?></td>
		</tr>
		<tr class="secondalt">
			<td height="35">
				<span style="padding-left:10px;">微信号 / WhatsApp：</span>
			</td>
			<td><?php echo ($inquiry["name"]); ?></td>
		</tr>
		<tr class="secondalt">
			<td width="15%" height="35"><span style="padding-left:10px;">邮箱：</span></td>
			<td><?php echo ($inquiry["email"]); ?></td>
		</tr>
		<tr class="secondalt">
			<td width="15%" height="35"><span style="padding-left:10px;">详细内容：</span></td>
			<td><?php echo ($inquiry["contents"]); ?></td>
		</tr>
		<tr class="firstalt">
			<td height="35"><span style="padding-left:10px;">时间</span></td>
    ...
    <table width="100%" height="35" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
      <tr>
          <td align="center">
