...
//<!CDATA[ 
var box_height  = new Array(350,400,260,260,350,410);
...
<div class="BodyLeft">
  <div id="frames" style="width:198px;height:600px;overflow:hidden;"> 
    ...
    <div class="text">
      <ul>
        <li><a href="<?php echo U('Product/add');?>" target="main">添加产品</a></li>
        <li><a href="<?php echo U('Product/index');?>" target="main">管理产品</a></li>
        <li><a href="<?php echo U('New/add');?>" target="main">添加新闻</a></li>
        <li><a href="<?php echo U('New/index');?>" target="main">管理新闻</a></li>
        <li><a href="<?php echo U('Photo/add');?>" target="main">添加图片</a></li>
		<li><a href="<?php echo U('Photo/index');?>" target="main">管理图片</a></li>
