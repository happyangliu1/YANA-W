...
.showMsg{border: 1px solid #47a2ff; zoom:1; width:450px; height:172px;position:absolute;top:44%;left:50%;margin:-87px 0 0 -225px}
...
<div class="showMsg" style="text-align:center">
	<h5>提示信息</h5>
    <?php if(isset($message)): ?><div class="content ok" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline;max-width:330px;"><?php echo($message); ?></div>
    <?php else: ?>
